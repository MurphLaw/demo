...
class FavoritiesModal extends StatefulWidget {
  const FavoritiesModal({super.key});

  @override
  State<FavoritiesModal> createState() => _LotteriesModalState();
}

class _LotteriesModalState extends State<FavoritiesModal> {
